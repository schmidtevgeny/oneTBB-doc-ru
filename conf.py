...
html_static_path = ['oneTBB/doc/_static']

if BUILD_TYPE == 'oneapi'  or BUILD_TYPE == 'dita':
    html_context = {
        'css_files': [
            'oneTBB/doc/_static/theme_overrides.css',  # override wide tables in RTD theme
        ],
    }
else:
    html_js_files = ['custom.js']
    html_logo = 'oneTBB/doc/_static/oneAPI-rgb-rev-100.png'
    
html_favicon = 'oneTBB/doc/_static/favicons.png'
...
epub_exclude_files = ['oneTBB/doc/search.html']
...
gettext_additional_targets =['literal-block', 'raw', 'image', 'index', 'doctest-block', 'code-block', 'parsed-literal']